...
void setup() {
  Serial.begin(115200);
  Ps3.begin("a0:5a:5a:a0:11:d8");  // configurate MAC address of Joystick and ESP32 (Install SixaxisPairTool for equipment mapping) https://www.filehorse.com/download-sixaxispairtool/
